...
<head>
    ...
    <meta name="theme-color" content="#111e29">
...
<aside class="sidebar" id="sidebar" aria-label="Navegación principal">
    <a class="brand" href="{{ route('dashboard') }}"><span class="brand-mark"><x-icon name="sun"/></span><span>SOLARIS<small>ENERGÍA QUE TRANSFORMA</small></span></a>
    ...
    <div class="sidebar-bottom">
        ...
        <div class="impact-note"><span class="impact-icon"><x-icon name="leaf"/></span><strong>Un futuro más limpio.</strong><p>Cada kilovatio cuenta para Guatemala.</p></div>
